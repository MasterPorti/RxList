...
function baseDemoStore(): Store {
  const nurses = [
    ...
    { id: "demo-nurse-2", name: "Laura Gómez", email: "laura.gomez@rxlist.com", floor: 1 as const, birthDate: "1991-06-12", status: "active" as const, userId: "demo-nurse-user-2", shifts: ["demo-shift-2"] },
    { id: "demo-nurse-3", name: "Pablo Martínez", email: "pablo.martinez@rxlist.com", floor: 2 as const, birthDate: "1988-09-03", status: "active" as const, userId: "demo-nurse-user-3", shifts: ["demo-shift-3"] },
    { id: "demo-nurse-4", name: "Andrés Silva", email: "andres.silva@rxlist.com", floor: 2 as const, birthDate: "1987-02-27", status: "active" as const, userId: "demo-nurse-user-4", shifts: ["demo-shift-4"] },
    { id: "demo-nurse-5", name: "Mariana Torres", email: "mariana.torres@rxlist.com", floor: 3 as const, birthDate: "1994-10-10", status: "active" as const, userId: "demo-nurse-user-5", shifts: ["demo-shift-5"] },
    { id: "demo-nurse-6", name: "Carmen Ruiz", email: "carmen.ruiz@rxlist.com", floor: 3 as const, birthDate: "1993-08-19", status: "active" as const, userId: "demo-nurse-user-6", shifts: ["demo-shift-6"] },
    { id: "demo-nurse-7", name: "Diego Hernández", email: "diego.hernandez@rxlist.com", floor: 4 as const, birthDate: "1990-01-26", status: "active" as const, userId: "demo-nurse-user-7", shifts: ["demo-shift-7"] },
    { id: "demo-nurse-8", name: "Ricardo Flores", email: "ricardo.flores@rxlist.com", floor: 4 as const, birthDate: "1989-12-05", status: "active" as const, userId: "demo-nurse-user-8", shifts: ["demo-shift-8"] },
  ];
  const patients = [
  ...
  const medications = [
    ...
    { id: "demo-med-2", patientId: patients[1].id, name: "Paracetamol", dose: "500 mg VO", times: ["08:00", "14:00", "20:00"], startDate: "2026-07-25", floor: 3 as const, nurseId: nurses[4].id, status: "active" as const },
    { id: "demo-med-3", patientId: patients[2].id, name: "Solución Hartmann", dose: "500 ml IV", times: ["09:00", "17:00"], startDate: "2026-07-27", floor: 2 as const, nurseId: nurses[2].id, status: "active" as const },
  ];
  const tasks = [
